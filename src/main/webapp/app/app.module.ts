...
import { ControlDinersAdminModule } from './admin/admin.module';
import { ControlDinersAccountModule } from './account/account.module';
...
export class ControlDinersAppModule {}
